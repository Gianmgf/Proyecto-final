...
\figura{\Tfig}{./isdb/time_deintrl_seccion.png}{Desentrelazador temporal.}{Adaptado de \cite{abnt}.}{\label{fig:desentrelazador_t}}
...
\figura{\Tfig}{./isdb/bit_deintrl_16.png}{Ejemplo de desentrelazador de bits para 16-QAM.}{}{\label{fig:bit_deintrl}}
