...
\figura{\Tfig}{isdb/segmentos.png}{Orden de los segmentos y ejemplo de configuración de capas.}{ Fuente: \cite{uruguay_tx}.}{\label{fig:segmentos}}
...
\figura{\Tfig}{isdb/canalizacion.png}{Frecuencia central y bandas de guarda.}{ Fuente: \cite{abnt}.}{\label{fig:canalizacion}}
...
\figura{\Tfig}{./isdb/cod_bloques.png}{Diagrama en bloques general del transmisor ISDB-Tb.}{Fuente: \cite{abnt}.}{\label{fig:bloques_isdb}}
...
\figura{\Tfig}{./isdb/tsp.png}{TSP con y sin protección.}{ Adaptado de \cite{abnt}}{\label{fig:paquete_TSP}}
...
\figura{\Tfig}{./isdb/intrlv_conv.png}
...
\figura{\Tfig}{./isdb/conv_code.png}
...
\figura{\Tfig}{./isdb/comb_jerarquica.png}
...
\figura{\Tfig}{./isdb/time_intrl.png}
...
\figura{\Tfig}{./isdb/time_intrl_seccion.png}
...
\figura{\Tfig}{./isdb/cuadro_seg.png}{Estructura del cuadro OFDM y organización de un segmento en el modo 1.}{ Adaptado de \cite{abnt}}{\label{fig:cuadro_seg}}
...
\figura{\Tfig}{./isdb/ig.png}{Diagrama del intervalo de guarda.}{ Fuente: \cite{abnt}}{\label{fig:ig}}
